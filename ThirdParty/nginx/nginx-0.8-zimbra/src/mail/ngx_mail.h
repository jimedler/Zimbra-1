...
typedef struct {
    ...
    unsigned                vlogin:2; /* vlogin = 0 alias is not looked up;
                                         vlogin = 1 alias has been looked up but not found;
                                         vlogin = 2 alias has been looke up and assigned to "login"
                                       */
...
#define NGX_MAIL_AUTH_PLAIN_IR  2
#define NGX_MAIL_AUTH_LOGIN     3
#define NGX_MAIL_AUTH_LOGIN_USERNAME    4
#define NGX_MAIL_AUTH_APOP      5
#define NGX_MAIL_AUTH_CRAM_MD5  6
#define NGX_MAIL_AUTH_GSSAPI    7
#define NGX_MAIL_AUTH_GSSAPI_IR 8
#define NGX_MAIL_AUTH_NONE      9
...
void ngx_mail_auth_http_void(ngx_mail_session_t *s);
/**/
